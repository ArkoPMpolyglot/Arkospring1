...
% you choose to use for either an Rint model or a Thevenin model 
...
% If you wish to create a Thevenin model, define rcValues to be 
...
% If you wish to create an extended Thevenin model having 
...
% a well-tuned Thevenin model, but it is also possible to get a 
% much better fit to the data using an extended Thevenin model.

function rcValues = tuneModel

  % BEGIN MODIFYING CODE AFTER THIS
  rcValues = [12.7,14.7,38]; % This is a sample value. You will need to change it.
end  
