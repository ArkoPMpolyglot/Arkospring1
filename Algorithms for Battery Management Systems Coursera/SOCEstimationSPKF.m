...
function [SigmaW, SigmaV, SigmaZ0] = tuneSPKF
  ...
  SigmaW  = .95e-2; % This is a sample value. You will need to change it.
  SigmaV  = .955e-3; % This is a sample value. You will need to change it.
  SigmaZ0 = .955e-2; % This is a sample value. You will need to change it.
