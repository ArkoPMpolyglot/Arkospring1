...
function [dz, gamma] = tunexLS(method)
  ...
  switch(method)
    ...
    case 2, % for the WTLS method ... you are required to tune these values
      dz = 32;      % This is a sample value. You will need to change it.
      gamma = 0.98;  % This is a sample value. You will need to change it.
    case 3, % for the TLS method ... you are required to tune these values
      dz = 46;      % This is a sample value. You will need to change it.
      gamma = 0.99;  % This is a sample value. You will need to change it.
    case 4, % for the AWTLS method ... you are required to tune these values
      dz = 35;      % This is a sample value. You will need to change it.
      gamma = 0.973;  % This is a sample value. You will need to change it.
  end
end  
