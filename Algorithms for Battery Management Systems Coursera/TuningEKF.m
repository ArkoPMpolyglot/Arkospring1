...
function [SigmaW, SigmaV, SigmaZ0] = tuneEKF
  ...
  SigmaW  = 1e-3; % This is a sample value. You will need to change it.
  SigmaV  = 1e-3; % This is a sample value. You will need to change it.
  SigmaZ0 = 1e-1; % This is a sample value. You will need to change it.
end  
